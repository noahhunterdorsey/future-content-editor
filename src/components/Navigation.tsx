      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          <div className="flex items-center gap-8">
            <span className="text-lg font-bold tracking-tight">Future</span>
          ...
          <Link
            href="/settings"
            className="p-2 rounded-md text-text-secondary hover:text-text hover:bg-bg-card transition-colors"
            title="Settings"
          >
